...
DEFAULT_LANG = {
    ...
    **dict(('entity.tfc.%s' % fish, lang(fish)) for fish in SIMPLE_FRESHWATER_FISH),
    ...
    'entity.tfc.bactrian_camel.male': 'Male Bactrian Camel',
    'entity.tfc.bactrian_camel.female': 'Female Bactrian Camel',
    ...
    **dict(('metal.tfc.%s' % metal, lang(metal)) for metal in METALS.keys()),
    ...
    'tfc.configuration.bactrian_camel': 'Bactrian Camel',
